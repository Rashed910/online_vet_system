...
class AppointmentAdmin(admin.ModelAdmin):
    list_display = ('id', 'patient_user', 'doctor', 'date', 'time', 'status', 'fee', 'created_at')
...
class PaymentAdmin(admin.ModelAdmin):
    list_display = ('id', 'appointment', 'amount', 'status', 'payment_method', 'created_at', 'paid_at')
...
class RefundAdmin(admin.ModelAdmin):
    list_display = ('id', 'appointment', 'original_amount', 'refund_amount', 'deduction_percentage', 'status', 'created_at', 'processed_at')
