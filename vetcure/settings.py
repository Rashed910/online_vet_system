"""
Django settings for vetcure project.
...
SECRET_KEY = 'django-insecure-^8)+-^9b+clng@4%7sw2*qqsbq6t$fi3g(++r%9*h2d@o4z@2+'
...
MIDDLEWARE = [
    ...
    'vetcure.middleware.NoCacheMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'vetcure.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'vetcure' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'vetcure.wsgi.application'
